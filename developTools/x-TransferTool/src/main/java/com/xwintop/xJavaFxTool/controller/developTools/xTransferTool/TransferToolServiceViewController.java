...
public class TransferToolServiceViewController extends TransferToolServiceViewView {
    ...
    public static FXMLLoader getFXMLLoader() {
        FXMLLoader fXMLLoader = new FXMLLoader(TransferToolServiceViewController.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/developTools/xTransferTool/TransferToolServiceView.fxml"));
        return fXMLLoader;
    }
