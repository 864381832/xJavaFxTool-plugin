...
public class LinuxPathToWindowsPathController implements Initializable {
	...
	public static FXMLLoader getFXMLLoader() {
		ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.LinuxPathToWindowsPath", Config.defaultLocale);
		URL url = Object.class.getResource("/fxml/LinuxPathToWindowsPath.fxml");
